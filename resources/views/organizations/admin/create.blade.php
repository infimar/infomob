...
<h1 class="page-header">Новая организация</h1>
		...
		<form class="form-horizontal" method="POST" action="/admin/organizations">
			...
			<fieldset>
			  	...
			  	<div class="form-group">
			    	...
			    	<div class="col-sm-10">
			      		<textarea class="form-control" id="inputDescription" name="description" placeholder="Описание" rows="10"></textarea>
			    	</div>
			  	</div>
