...
class ParseIt extends Command
{
    ...
    'Автосервис / Автотовары'     => 1,
      ...
      'Топливные карты' => 2,
      'Автомобильные запчасти' => 2,
      'Спецтехника и запчасти' => 2,
      'Аксессуары и запчасти' => 2,
      ...
      'Автомобили' => 6,
      'Автосервисы' => 6,
      'Автохимия и автокосметика' => 6,
      'Автотюнинг' => 6,
      'Автоэлектроника' => 6,
      'Услуги автовладельцам' => 6,
      'Автосервис' => 6,

      // Автостоянки - 7
      'Автостоянки' => 7,
      'АЗС, гаражи, стоянки' => 7,
      ...
      'Перевозки пассажиров и грузов' => 9,
      'Аренда, перевозки' => 9,
      ...
      'Автосалонные услуги' => 11,
      'Продажа авто' => 11,

      // Аренда авто - 12
      'Прокат автотранспорта' => 12,
      'Аренда транспорта' => 12,
    ...
    'Город / Власть'     => 30,
      ...
      // Областной акимат - 31
      'Акимат области' => 31,
      'Аппарат акима области' => 31,

      // Городской акимат - 32
      'Акимат города' => 32,
      'Маслихат города' => 32,
      'Аппарат акима города' => 32,
      ...
      'Органы государственного контроля и надзора' => 35,
      'Прокуратуры и суды' => 35,
      'Полиция, УВД, ОВД, ОВИР' => 35,
      'Правоохранительные органы' => 35,
      ...
      'Таможня' => 36,
      'Управа, администрация, учреждения' => 36,
      'Здравоохранение' => 36,
      'Органы управления области' => 36,
      ...
      'Водоснабжение и водоотведение' => 42,
      'Жилищно-коммунальные услуги' => 42,
    ...
    'Досуг / Развлечения / Общественное питание' => 83,
      ...
      'Рестораны национальной кухни' => 87,
      'Рестораны, залы торжеств' => 87,

      // Ночные клубы, бары - 88
      'Бары' => 88,
      'Ночные клубы' => 88,
      'Бары и пабы' => 88,
      'Ночные клубы и бильярд' => 88,
      ...
      'Пиццерии' => 93,
      'Столовые' => 93,
      'Предприятия общественного питания' => 93,
      'Бары, кафе, закусочные' => 93,
    ...
    'Охрана / Безопасность' => 13,
      ...
      'Услуги охраны' => 14,
      'Охранные предприятия, системы безопасности' => 14,
      'Организации' => 14,
    ...
    'Компьютеры / Бытовая техника / Офисная техника' => 99,
      ...
      'Фототовары' => 100,
      'Аудио-, видео-, бытовая техника' => 100,

      // Бытовая техника - 101
      'Бытовая техника' => 101,
      'Запчасти / аксессуары для бытовой техники' => 101,
      'Кофемашины' => 101,
      'Бытовая, аудио-видео техника' => 101,
      'Техника для дома и кухни' => 101,
      ...
      'Компьютерная техника и программное обеспечение' => 102,
      'Компьютеры и оргтехника' => 102,
      ...
      'Электротехника и инструмент' => 104,
    ...
    'Интернет / Связь / Информационные технологии' => 44,
      ...
      'Автоматизированные системы управления' => 45,
    ...
    // Красота и здоровье - 49
      ...
      'Парфюмерно-косметические товары' => 51,
      'Косметика и аксессуары' => 51,
      'Косметика и парфюмерия' => 51,

      // Салоны красоты - 52
      'Парикмахерские' => 52,
      'Салоны красоты' => 52,
      'Парикмахерские услуги' => 52,
      'Салоны и парикмахерские' => 52,
      ...
      'Ювелирные камни' => 55,
      'Ювелирные изделия и часы' => 55,
      'Бижутерия и украшения' => 55,
      'Ювелирные изделия и украшения' => 55,
    ...
    'Медицина / Здоровье / Красота' => 111,
      ...
      // Аптеки - 112
      'Аптеки' => 112,
      'Аптеки и фармацевтика' => 112,

      // Больницы - 113
      'Больницы' => 113,
      'Госпитали' => 113,
      'Больницы и госпитали' => 113,

      // Поликлиники - 114
      'Детские поликлиники' => 114,
      'Взрослые поликлиники' => 114,
      'Поликлиники, травмпункты' => 114,
      ...
      'Специализированные медицинские и диагностические центры' => 115,
      'Диспансеры' => 115,
      'Медико-биологические исследования' => 115,
      'Медицинские учреждения' => 115,
      'Медицинские центры' => 115,
      ...
      'Медуслуги, консультации, лаборатории' => 120,
    ...
    // Недвижимость - 75
      ...
      'Агентства недвижимости, риэлторские услуги' => 76,
      'Недвижимость' => 76,
      ...
      'Бизнес-центры, деловые центры, офисные центры, конференц залы' => 78,
      'Сдача в аренду' => 78,
      'Сдача недвижимости в аренду' => 78,
    ...
    // Оборудование - 79
      ...
      'Инструменты' => 80,
      // 'Оборудование' => 80,
      'Отопительное и водонагревательное оборудование' => 80,
      'Производственное и промышленное оборудование' => 80,
      'Контрольно-измерительные приборы' => 80,
      'Сельхозтехника и оборудование' => 80,
      'Оборудование для автомобилей' => 80,
    ...
    // Образование - 67
      ...
      'Автомотошколы' => 68,
      'Бизнес-образование' => 68,
      'Курсы и мастер-классы' => 68,
      'Музыкальное искусство' => 68,
      'Образование за рубежом' => 68,
      'Повышение квалификации' => 68,
      'Репетиторские услуги' => 68,
      'Танцевальные школы' => 68,
      'Курсы иностранных языков' => 68,
      'Тренинги и семинары' => 68,
      'Курсы по специальности' => 68,

      // Высшие учебные заведения - 69
      'Академии' => 69,
      'Институты' => 69,
      'Университеты' => 69,
      'Высшее образование' => 69,
      'ВУЗы и университеты' => 69,
      ...
      'Школы' => 73,
      'Школы-интернаты' => 73,
      'Творческие школы и студии' => 73,
      'Школы, лицеи, гимназии' => 73,

      // Внешкольные учреждения - 74
      'Культура, образование' => 74,
      'Дополнительное образование детей' => 74,
      'Внеклассная работа' => 74,
    ...
    'Одежда / Обувь' => 124,
      ...
      'Услуги вышивки' => 125,
      'Пошив одежды и обуви' => 125,
      'Пошив и реставрация одежды' => 125,
      ...
      'Магазины одежды и обуви' => 128,
      'Спецодежда и обувь' => 128,
      'Одежда, обувь и аксессуары' => 128,
    ...
    // Производство, промышленность и сельское хозяйство - 140
      ...
      'Яйцо' => 142,
      'Пищевая промышленность' => 142,
      'Продовольственные товары' => 142,
      'Кормопроизводство' => 142,
      ...
      'Текстиль для дома' => 147,
      'Текстильная промышленность' => 147,

      // Промышленные предприятия - 148
      'Горнодобывающая промышленность' => 148,
      'Промышленные предприятия' => 148,
      'Упаковочная промышленность' => 148,
      'Стекольная промышленность' => 148,
      'Полиграфическая промышленность' => 148,
      'Мебельная промышленность' => 148,
      'Строительная промышленность' => 148,
      'Автомобильная промышленность' => 148,
      'Сельскохозяйственные организации' => 148,
      'Легкая промышленность' => 148,
      'Целлюлозно-бумажная промышленность' => 148,
      'Топливная промышленность' => 148,
      'Промышленные материалы и сырье' => 148,
      'Дереовобрабатывающая промышленность' => 148,
      'Электротехническая промышленность' => 148,
      'Фармацевтическая промышленность' => 148,
      'Инструментальная промышленность' => 148,
      'Керамическая промышленность' => 148,
      'Кожевенно-обувная промышленность' => 148,
      'Химическая промышленность' => 148,
      'Парфюмерно-косметическая промышленность' => 148,
      'Промышленное производство' => 148,
    ...
    // Связь и коммуникации - 58
      ...
      'Сотовые телефоны и аксессуары' => 59,

      // Сайты - 60
      'Виртуальные туры' => 60,
      'Городские информационные сайты' => 60,
      'Сайты объявлений' => 60,
      'Интернет-бизнес, информационные технологии, сайты' => 60,
      'Интернет' => 60,
    ...
    // Спорт - 149
      ...
      'Яхт-клубы' => 150,
      'Скалодромы' => 150,
      'Спортивные комплексы и объекты' => 150,
      'Фитнес' => 150,
      ...
      'Велосипеды' => 152,
      'Спортивные секции, школы и клубы' => 152,
      'Спортивные клубы и центры' => 152,
    ...
    // Строительство - 156
      ...
      'Цемент' => 157,
      'Окна, двери' => 157,
      'Заборы и ограждения' => 157,
      'Потолки и потолочные материалы' => 157,
      'Ворота, калитки и шлагбаумы' => 157,
      'Материалы и оборудование' => 157,

      // Строительное оборудование - 158
      'Гидромассажное оборудование' => 158,
      'Оборудование для очистки воды' => 158,
      'Строительная техника и оборудование' => 158,
      ...
      'Строительные организации, услуги' => 162,
      'Строительно-монтажные работы' => 162,
      'Ландшафтное строительство и дизайн' => 162,
      ...
      'Строительные работы и услуги' => 163,
    ...
    // Торговля - 166
      ...
      'Книги, канцтовары' => 168,
      'Канцелярская отрасль' => 168,
      'Канцтовары, расходные материалы' => 168,
      'Книги и печатная продукция' => 168,

      // Свадебные и цветочные салоны - 169
      'Доставка цветов' => 169,
      'Цветы' => 169,
      'Цветы, сад и огород' => 169,
      'Свадебные услуги' => 169,
      ...
      'Товары для активного отдыха и спорта' => 170,
      ...
      'Зоотовары' => 172,
      'Собаководство' => 172,
      'Овощеводство и бахчеводство' => 172,

      // Супермаркеты - 173
      'Гипермаркеты' => 173,
      'Супермаркеты' => 173,
      'Магазины и супермаркеты' => 173,

      // Мебель - 174
      'Надувная мебель / бассейны' => 174,
      'Мебельные магазины' => 174,
      'Производство мебели' => 174,

      // Рынки - 175
      'Рынки' => 175,
      'Универсальные магазины, рынки' => 175,

      // Торговые организации - 176
      'Оптовая торговля' => 176,
      'Торговые и торгово-закупочные организации, предприятия' => 176,
      ...
      'Оружейные, рыболовные магазины' => 179,
    ...
    // Туризм - 186
      ...
      // Базы отдыха - 187
      'Базы отдыха' => 187,
      'Лечебно-оздоровительный туризм' => 187,
    ...
    // Услуги и сервис - 191
      ...
      'Юридические услуги, адвокаты, нотариусы, нотариальные конторы' => 192,
      'Юридические услуги' => 192,
      ...
      'Ремонт бытовой техники' => 194,
      'Ремонт оргтехники' => 194,
      'Ремонт техники' => 194,
      'Ремонт оборудования и приборов' => 194,
      'Ремонт часов, ювелирных украшений, мебели' => 194,
      'Ремонт транспорта' => 194,
      ...
      'Реклама и маркетинг' => 201,
      'Рекламные агентства' => 201,
    ...
    // Финансовые услуги - 19
      ...
      'Банки, финансовые организации' => 20,
      'Банки и филиалы' => 20,
      ...
      'Страхование' => 26,
      'Пенсионные фонды и страхование' => 26,

      // Аудит, консалтинг - 27
      'Аудиторские фирмы, бухгалтерские услуги, консалтинговые компании' => 27,
      'Аудит и консалтинг' => 27,
